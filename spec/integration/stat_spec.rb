...
describe MongoHQ::DatabaseStats do
  context "should stats" do
    it "is successful" do
      FakeWeb.register_uri(:get, "https://api.mongohq.com/databases/my_database.mongohq.com:10005/stats?_apikey=sekret",
                           :status => "200",
      ...
      db    = MongoHQ::Database.new(:host_name => "my_database.node0.mongohq.com", :port => "10005")
      stats = db.stats
