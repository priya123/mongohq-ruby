...
describe MongoHQ::DatabaseStats do
    ...
    it "it should give me some data" do
      FakeWeb.register_uri(:get, "https://api.mongohq.com/deployments/my_database.node0.mongohq.com:10005/stats?_apikey=sekret",
                           :status => "200",
      ...
      stats.members.first.should respond_to(:index_misses_percentage)
    end
